...
class GuangdongfiveSpider(scrapy.Spider):
    name = 'guangdongfive'
    allowed_domains = ['www.gdei.gov.cn']
    start_urls = ['http://www.gdei.gov.cn/ywfl/jnhxhjj/']
    baseurl = "http://www.gdei.gov.cn/ywfl/jnhxhjj/index_"
    num = 1
    def parse(self, response):
        ...
        for i in r:
            # print i
            yield scrapy.Request("http://www.gdei.gov.cn/ywfl/jnhxhjj" + i, callback=self.parse_one)
            # num = 1的时候,是第二页
