...
class GuangdongfourSpider(scrapy.Spider):
    name = 'guangdongfour'
    allowed_domains = ['http://www.gdei.gov.cn']
    start_urls = ['http://www.gdei.gov.cn/ywfl/jscx/']
    baseurl = "http://www.gdei.gov.cn/ywfl/jscx/index_"
    num = 1
    def parse(self, response):
        ...
        for i in r:
            # print i
            yield scrapy.Request("http://www.gdei.gov.cn/ywfl/jscx" + i, callback=self.parse_one)
            # num = 1的时候,是第二页,23
