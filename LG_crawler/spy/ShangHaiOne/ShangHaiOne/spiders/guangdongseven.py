...
class GuangdongsevenSpider(scrapy.Spider):
    name = 'guangdongseven'
    allowed_domains = ['www.gdei.gov.cn']
    start_urls = ['http://www.gdei.gov.cn/ywfl/xxh/']
    baseurl = "http://www.gdei.gov.cn/ywfl/xxh/index_"
    num = 1
    def parse(self, response):
        ...
        for i in r:
            # print i
            yield scrapy.Request("http://www.gdei.gov.cn/ywfl/xxh" + i, callback=self.parse_one)
            # num = 1的时候,是第二页,25
